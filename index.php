          ...
          <div class="row">
            ...
            <div class="col-sm-4 offset-md-1 py-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="https://www.prefeitura.sp.gov.br/cidade/secretarias/licenciamento/"  class="text-white" >Secretaria Municipal de Urbanismo e Licenciamento</a></li>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap" src="img/adduser.png">
                <div class="card-body">
                  <p class="card-text">Script para adicionar novos usuários no Banco de Dados.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary" onclick="window.location.href='gerarusuarios.php'">Executar</button>                     
                    </div>                   
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap" src="img/loginrede.png">
                <div class="card-body">
                  <p class="card-text">Script para adicionar o login de rede dos usuários na tabela.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary" onclick="window.location.href='usuarioderede.php'">Executar</button>                     
                    </div>                   
                  </div>
                </div>
              </div>
